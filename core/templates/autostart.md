# {{entry}} / Auto-arranque de la stele
...
<!-- BOOTSTRAP: emitir un @import por cada rol `startup: obligatorio`, ordenado por `order`,
     con la ruta resuelta {base}/[{history_dir}/]{nombre}. Ejemplo con defaults (base=.): -->
@AGENTS.md
@MEMORY.md
@HISTORY/LATEST.md
@HISTORY/HANDOVER.md
